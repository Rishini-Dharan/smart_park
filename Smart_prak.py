...
def log_vehicle(vehicle_type, vehicle_model, action):
    ...
    try:
        ...
        print(f"Logged: {vehicle_type} {vehicle_model} {action} at {time} on {date}")
    except PermissionError:
        print("Error: Permission denied while writing to CSV. Ensure the file is not open elsewhere.")

# Initialize CSV before starting detection
initialize_csv()
